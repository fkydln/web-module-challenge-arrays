...
function getFlavorByIndex(recipe,order){
...
copy(originalFlavors, secretFlavors)
...
function filterByWord(param1,param2){
    ...
    for (let index = 0; index < originalFlavors.length; index++) {
        ...
        if (originalFlavors[index].includes(param2)){
            param1.push(originalFlavors[index]);
        }
    }
    console.log(param1);
}
filterByWord(filteredArray,"Chocolate")
